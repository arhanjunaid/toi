...
<!--                             <ul class="offcanvas__sub_menu">
    ...
    <main class="main__content_wrapper">
        ...
        <!--  <section class="breadcrumb__section breadcrumb__bg" style="background-image: url('public/images/banner.jpg');background-position: center;background-size: cover;height: 700px;"> -->
             <section class="breadcrumb__section breadcrumb__bg" style="background-color:gray;">
            <div class="container">
                            ...
                            <div class="contact__info border-radius-10">
                                ...
                                <div class="contact__info--items">
                                    ...
                                    <div class="contact__info--items__inner d-flex">
                                        ...
                                        <div class="contact__info--content">
                                            <p class="contact__info--content__desc text-white">  123 Stree name, City ,
                                                state,Country
                                                Pincode.</p> 
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-7">
                            <div class="contact__form">
                                <form class="contact__form--inner"  action="#"method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="contact__form--list mb-20">
                                                ...
                                                <input class="contact__form--input" name="name" id="name" placeholder="Your Name" type="text" required>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                ...
                                                <input class="contact__form--input" name="email" id="email" placeholder="Your Email" type="text" required>
                                                
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input4">Subject <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input" name="subject" id="subject" placeholder="Subject" type="text" required>
                                        ...
                                        <div class="col-12">
                                            <div class="contact__form--list mb-10">
                                                ...
                                                <textarea class="contact__form--textarea" name="message" id="message" placeholder="Write Your Message"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <button class="contact__form--btn primary__btn" type="submit" id="contactdata">Submit Now</button>  
        ...
        <div class="row">
            <div class="col-lg-3">
                <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide8.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            ...
            <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide9.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
            <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide10.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
                <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide11.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide12.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            ...
            <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide13.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
            <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide14.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
                <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide15.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
        ...
        <div class="row">
            <div class="col-lg-3">
                <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide16.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            ...
            <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide17.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
            <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide18.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
                <div class="col-lg-3">
                 <article class="product__card--content">
                    <div class="card">
                    <div class="card-body">
                        <img src="public/images/gallery/BV Guide19.jpg" alt="gallery1">
                    </div>
                </div>
                </article>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $("#contactdata").on('click',function(e){
            e.preventDefault();
