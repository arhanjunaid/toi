            ...
            <div class="container">
                <div class="main__header--inner d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="home"><img class="main__logo--img" src="public/assetsj/images/client-logo/logo.jpg" alt="logo-img" width="300px"></a></h1>
                    </div>
                    <div class="header__menu d-none d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link " href="contactus">Contact <!-- <span class="menu__plus--icon">+</span> --></a>
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn" href="#">
                                    <!-- <svg xmlns="http://www.w3.org/2000/svg"  width="26.51" height="23.443" viewBox="0 0 512 512"><path d="M344 144c-3.92 52.87-44 96-88 96s-84.15-43.12-88-96c-4-55 35-96 88-96s92 42 88 96z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path d="M256 304c-87 0-175.3 48-191.64 138.6C62.39 453.52 68.57 464 80 464h352c11.44 0 17.62-10.48 15.65-21.4C431.3 352 343 304 256 304z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/></svg>  -->
                                      <p class="dropdown-toggle" data-toggle="dropdown">{{$LoggedUserInfo['firstName']}}{{$LoggedUserInfo['lastName']}}</p>
            ...
            <div class="offcanvas__inner">
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li">
                            <a class="offcanvas__menu_item" href="contactus">Contact</a>
<!--                             <ul class="offcanvas__sub_menu">
        ...
        <!-- End header area -->
           ...
           <a href="https://api.whatsapp.com/send?phone=+91xxxxxxxxxx"  target="_blank">
                <img src="public/images/icons/watsapp.jpeg" width="50px" height="50px" class="float">
                 </a>
                  <a href="buynow"  target="_blank">
                <img src="public/images/icons/buy_now.jpeg" width="100px" height="100px" class="float1">
                 </a>

<!-- bg image-->
<div class="row">
    <div class="col-lg-12" style="width: 100%;height: 600px;background-color: red;background-image: url('public/assetsj/images/main-slider/vkb1.png');background-position: center;background-size: cover;">
...
<!-- bg image end-->
                            ...
                            <div class="hero__slider--activation swiper">
                                <div class="hero__slider--wrapper swiper-wrapper">
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="public/images/musicplayer/product1.jpg" alt="slider img" width="300px" height="300px">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Tune into the Bhakti zone at your house</h2>
                                                <p class="slider__content--desc d-sm-2-none">As the world moves on at a fast pace, the need to keep one's mind calm and immersed in a spiritual plane while living in the present becomes very important.</p>  
                                                <div class="slider__content--footer d-flex align-items-center justify-content-center">
                                                    <a class="slider__content--btn primary__btn" href="buynow_without_login">Shop Now</a>
                                                    <div class="bideo__play slider__play--bideo">
                                                        <a class="bideo__play--icon glightbox" href="public/videos/productvideo.mp4" data-gallery="video">
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="public/images/musicplayer/product4.jpg" alt="slider img" width="300px" height="300px">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Tune into the Bhakti zone at your house</h2>
                                                <p class="slider__content--desc d-sm-2-none">The Family Bhakti Player helps you tune into Bhakti music, devotional songs, mantras, music therapy, gives you a glimpse into festivals and fairs, moral stories, discourse from the heads of Mutts and religious thinkers.</p>  
                                                <div class="slider__content--footer d-flex align-items-center justify-content-center">
                                                    <a class="slider__content--btn primary__btn" href="buynow_without_login">Shop Now</a>
                                                    <div class="bideo__play slider__play--bideo">
                                                        <a class="bideo__play--icon glightbox" href="public/videos/productvideo.mp4" data-gallery="video">
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="public/images/musicplayer/product3.jpg" alt="slider img" width="300px" height="300px">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Tune into the Bhakti zone at your house</h2>
                                                <p class="slider__content--desc d-sm-2-none">The Family Bhakti Player is also loaded with programs that will take you to a world of Bhakti, that you can listen to anywhere you please! </p>  
                                                <div class="slider__content--footer d-flex align-items-center justify-content-center">
                                                    <a class="slider__content--btn primary__btn" href="buynow_without_login">Shop Now</a>
                                                    <div class="bideo__play slider__play--bideo">
                                                        <a class="bideo__play--icon glightbox" href="public/videos/productvideo.mp4" data-gallery="video">
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="hero__slider--items">
                                            <div class="hero__slider--thumbnail">
                                                <img class="hero__slider--thumbnail__img display-block" src="public/images/musicplayer/product6.jpg" alt="slider img" width="300px" height="300px">
                                            </div>
                                            <div class="slider__content text-center">
                                                <h2 class="slider__content--maintitle h1">Tune into the Bhakti zone at your house</h2>
                                                <p class="slider__content--desc d-sm-2-none"> Connecting to Family Bhakti Player is very easy as you can do so wirelessly via Bluetooth and also use it as your Bluetooth speaker. Through USB, you can play your favourite Bhajans and also use the player as an FM Radio!</p>  
                                                <div class="slider__content--footer d-flex align-items-center justify-content-center">
                                                    <a class="slider__content--btn primary__btn" href="buynow_without_login">Shop Now</a>
                                                    <div class="bideo__play slider__play--bideo">
                                                        <a class="bideo__play--icon glightbox" href="public/videos/productvideo.mp4" data-gallery="video">
   ...
   <!-- second main header end-->
    <main class="main__content_wrapper">
        <!-- Start slider section -->
       <!--  <section class="hero__slider--section slider__section--bg4" style="background-image: url('public/assetsj/images/main-slider/vkb1.png');">
            <div class="hero__slider--inner position__relative">
                <div class="container">
                    <div class="hero__slider--activation swiper">
                        <div class="hero__slider--wrapper swiper-wrapper">
                                    ...
                                    <div class="row row-cols-md-2 row-cols-1 align-items-center">
                                        <div class="col col-sm-order">
                                            <div class="slider__content style4">
                                                <h2 class="slider__content--maintitle h1">There For Headset
                                                    Time Song.  </h2>
                                                <p class="slider__content--desc style4 d-sm-2-none">There are many variations of passages of Lorem Ipsum
                                        ...
                                        <div class="col">
                                            <div class="hero__slider--thumbnail style4">
                                                <img class="hero__slider--thumbnail__img style4 display-block" src="public/images/musicplayer/product1.jpg" alt="slider img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide ">
                                <div class="hero__slider--items style4">
                                    <div class="row row-cols-md-2 row-cols-1 align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="hero__slider--thumbnail style4">
                                                <img class="hero__slider--thumbnail__img style4 display-block" src="public/images/musicplayer/product3.jpg" alt="slider img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide ">
                                <div class="hero__slider--items style4">
                                    <div class="row row-cols-md-2 row-cols-1 align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="hero__slider--thumbnail style4">
                                                <img class="hero__slider--thumbnail__img style4 display-block" src="public/images/musicplayer/product4.jpg" alt="slider img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide ">
                                <div class="hero__slider--items style4">
                                    <div class="row row-cols-md-2 row-cols-1 align-items-center">
                                        ...
                                        <div class="col">
                                            <div class="hero__slider--thumbnail style4">
                                                <img class="hero__slider--thumbnail__img style4 display-block" src="public/images/musicplayer/product6.jpg" alt="slider img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
      ...
      <!--   <section class="image__with--text__section section--padding">
                ...
                <div class="row row-cols-md-2 row-cols-1  align-items-center">
                    <div class="col">
                        <div class="image__with--text__thumbnail">
                            <img class="display-block" src="assets/img/other/about-thumb4.webp" alt="drone-image">
                        </div>
                    </div>
                    <div class="col">
        ...
        <!-- End image with text section -->
         ...
         <!-- Start about section -->
         <section class="about__section section--padding border-bottom pt-0" id="about">
            <div class="container">
                <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 align-items-center">
                    <div class="col">
                        <div class="about__content">
                            <h2 class="about__content--title mb-18">Tune into the Bhakti zone at your house</h2>
                            <div class="about__content--step mb-25">
                                <p class="about__content--desc mb-20">As the world moves on at a fast pace, the need to keep one's mind calm and immersed in a spiritual plane while living in the present becomes very important. To help find solace in Bhakti songs, and induce spiritual and cultural thoughts, Vijay Karnataka (No.1 Kannada newspaper) and Bodhivruksha present the “Family Bhakti Player”.</p>
                                <ul class="mb-20">
                                    <li class="about__content--desc__list">Bluetooth facility</li>
                                    <li class="about__content--desc__list">FM </li>
                                </ul>
                    ...
                    <div class="col">
                        <div class="about__thumbnail">
                            <img class="display-block" src="public/images/musicplayer/product1.jpg" alt="about-thumb">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="product__details--section section--padding">
            <div class="container">
                <div class="section__heading text-center mb-50">
                    <h2 class="section__heading--maintitle text__secondary mb-10">Featured Trending Now</h2>
                    <p class="section__heading--desc">As the world moves on at a fast pace, the need to keep one's mind calm and immersed in a spiritual plane while living in the present becomes very important. To help find solace in Bhakti songs, and induce spiritual and cultural thoughts, Vijay Karnataka (No.1 Kannada newspaper) and Bodhivruksha present the “Family Bhakti Player”.</p>
                </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="public/images/musicplayer/product1.jpg" alt="product-nav-img1">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="public/images/musicplayer/product3.jpg" alt="product-nav-img2">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="public/images/musicplayer/product5.jpg" alt="product-nav-img3">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="public/images/musicplayer/product6.jpg" alt="product-nav-img4">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="product__media--nav__items--img" src="public/images/musicplayer/product1.jpg" alt="product-nav-img5">
                                            </div>
                                        </div>
                                        <!-- <div class="swiper-slide">
                                            <div class="product__media--nav__items">
                                                <img class="public/images/musicplayer/product1.jpg" alt="product-nav-img6">
                                            </div>
                                        </div> -->
                                    </div>
                                </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="public/images/musicplayer/product1.jpg"><img class="product__media--preview__items--img" src="public/images/musicplayer/product1.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="public/images/musicplayer/product1.jpg" data-gallery="product-media-preview">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="public/images/musicplayer/product3.jpg"><img class="product__media--preview__items--img" src="public/images/musicplayer/product3.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="public/images/musicplayer/product3.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="public/images/musicplayer/product5.jpg"><img class="product__media--preview__items--img" src="public/images/musicplayer/product5.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="public/images/musicplayer/product5.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="product__media--preview__items">
                                                    <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="public/images/musicplayer/product6.jpg"><img class="product__media--preview__items--img" src="public/images/musicplayer/product6.jpg" alt="product-media-img"></a>
                                                    <div class="product__badge">
                                                        <span class="product__badge--items sale">New</span>
                                                    </div>
                                                    <div class="product__media--view__icon">
                                                        <a class="product__media--view__icon--link glightbox" href="public/images/musicplayer/product6.jpg" data-gallery="product-media-preview">
                                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                                <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                            </svg>                                                              
                                                            <span class="visually-hidden">Media Gallery</span>
                        ...
                        <div class="col">
                            <div class="product__details--info">
                                <form enctype="multipart/form-data" method="get" class="cart" action="buynow">
                                        @csrf
                                    <h3 class="product__details--info__title mb-15">Tune into the Bhakti zone at your house</h3>
                                    ...
                                    <div class="product__details--info__price mb-10">
                                        <span class="current__price">RS.2000.00</span>
                                        <span class="old__price">RS.3000.00</span>
                                    </div>  
                                            ...
                                            <fieldset class="variant__input--fieldset">
                                                ...
                                                <div class="variant__color d-flex">
                                                    <div class="variant__color--list">
                                                        ...
                                                        <label class="variant__color--value red" for="color-red1" title="Red"><img class="variant__color--value__img" src="public/images/musicplayer/product1.jpg" alt="variant-color-img"></label>
                                                    </div>
                                                    <div class="variant__color--list">
                                                        <input id="color-red2" name="color" type="radio">
                                                        <label class="variant__color--value red" for="color-red2" title="Black"><img class="variant__color--value__img" src="public/images/musicplayer/product2.jpg" alt="variant-color-img"></label>
                                                    </div>
                                                    <div class="variant__color--list">
                                                        <input id="color-red3" name="color" type="radio">
                                                        <label class="variant__color--value red" for="color-red3" title="Pink"><img class="variant__color--value__img" src="public/images/musicplayer/product5.jpg" alt="variant-color-img"></label>
                                                    </div>
                                                    <div class="variant__color--list">
                                                        <input id="color-red4" name="color" type="radio">
                                                        <label class="variant__color--value red" for="color-red4" title="Orange"><img class="variant__color--value__img" src="public/images/musicplayer/product6.jpg" alt="variant-color-img"></label>
                                                    </div>
                                                </div>
                                            </fieldset>
                                        </div> -->
...
<!--                                         <div class="product__variant--list mb-15">
                                    ...
                                    <div class="guarantee__safe--checkout">
                                        ...
                                        <img class="guarantee__safe--checkout__img display-block" src="public/images/payment/safe-checkout.webp" alt="Payment Image">
                                    </div>
                                </form>
        ...
        <!-- Start deals section -->
       <!--  <section class="deals__section deals__section--bg3 section--padding">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-7 col-sm-order">
                        <div class="deals__content">
                            ...
                            <div class="deals__countdown d-flex mb-50" data-countdown="Sep 30, 2022 00:00:00"></div>
                            <a class="deals__content--btn primary__btn" href="shop.html">Shop Now</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-5">
                        <div class="deals__thumbnail--style3 text-right">
                            <img class="deals__thumbnail--style3__img" src="assets/img/other/head-phone.webp" alt="deals-thumb">
                        </div>
                    </div>
                </div>
            </div>
       ...
       <!--   <section class="team__section section--padding">
        ...
        <section class="newsletter__section newsletter__bg2 section--padding" style="background-image: url('public/images/banner.jpg');background-position: center;background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                        <div class="newsletter__content--style2 text-center position__relative">
                            <h2 class="newsletter__content--title__style2 text-white">We Best To Immediately Do 
                            ...
                            <a class="bideo__play--icon banner__video--play__icon style4 glightbox" href="public/videos/productvideo.mp4" data-gallery="video">
        ...
        <section class="product__section section--padding" id="gallery">
            <div class="container">
                <div class="section__heading text-center mb-50">
                ...
                <div class="product__inner">
                    <div class="row row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                        <div class="col custom-col-2 mb-30">
                            <!-- <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product23.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product21.webp" alt="product-img">
                                    </a>
                            ...
                            <article class="product__card--content">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="public/images/gallery/BV Guide4.jpg" alt="gallery1">
                                    </div>
                                </div>
                            </article>
                        </div>
                          ...
                          <!--   <article class="product__card">
                                <div class="product__card--thumbnail product__swiper--column1 swiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                                <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product21.webp" alt="product-img">
                                                <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product22.webp" alt="product-img">
                                            </a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a class="product__card--thumbnail__link display-block" href="product-details.html">
                             ...
                             <article class="product__card--content">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="public/images/gallery/BV Guide5.jpg" alt="gallery1">
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col custom-col-2 mb-30">
                           <!--  <article class="product__card">
                                <div class="product__card--thumbnail">
                                    <a class="product__card--thumbnail__link display-block" href="product-details.html">
                                        <img class="product__card--thumbnail__img product__primary--img display-block" src="assets/img/product/product22.webp" alt="product-img">
                                        <img class="product__card--thumbnail__img product__secondary--img display-block" src="assets/img/product/product23.webp" alt="product-img">
                                    </a>
                                    <ul class="product__card--action d-flex align-items-center justify-content-center">
                                        <li class="product__card--action__list">
                                            <a class="product__card--action__btn" title="Wishlist" href="wishlist.html">
                             ...
                             <article class="product__card--content">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="public/images/gallery/BV Guide6.jpg" alt="gallery1">
                                    </div>
                                </div>
                            </article>
                        </div>
                        <div class="col custom-col-2 mb-30 d-none d-sm-block">
                            <!-- <article class="product__card">
                             ...
                             <article class="product__card--content">
                                <div class="card">
                                    <div class="card-body">
                                        <img src="public/images/gallery/BV Guide7.jpg" alt="gallery1">
                                    </div>
                                </div>
                            </article>
                        </div>
                        <button class="primary__btn"><a href="">View More</a></button>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="blog__section blog__section--bg section--padding">
            <div class="container">
                <div class="section__heading text-center mb-50">
                    <h2 class="section__heading--maintitle text__secondary mb-10">You Will Love It.</h2>
                    <h4 class="section__heading--desc">How It Works</h4>
                </div>
                                ...
                                <div class="col-lg-4 col-md-12 m-b30 how-it-drone3-left">
                                    ...
                                    <div class="wt-box d-icon-box-two m-b40">
                                        <div class="wt-icon-box-wraper right ">
                                           ...
                                           <!--  <div class="icon-md inline-icon">
                                            ...
                                            <div class="icon-content" style="line-height: 2;">
                                                <div class="d-icon-box-title title-style-2 site-text-secondry">
                                                    <h3  class="s-title-one">How To Use Mode</h3>
                                                </div>
                                                
                                                <div class="d-icon-box-content">
                                                    <p>Press the "M" key to enter the FM Mode </p>
                                                </div>                                        
                                            </div>
                                    ...
                                    <div class="wt-box d-icon-box-two m-b40">
                                        <div class="wt-icon-box-wraper right">
                                            ...
                                            <div class="icon-content" style="line-height: 2;">
                                                <div class="d-icon-box-title title-style-2 site-text-secondry">
                                                    <h3  class="s-title-one">How To connect Bluetooth</h3>
                                                </div>
                                    ...
                                    <div class="wt-box d-icon-box-two m-b40">
                                        <div class="wt-icon-box-wraper right">
                                            ...
                                            <div class="icon-content" style="line-height: 2;">
                                                <div class="d-icon-box-title title-style-2 site-text-secondry">
                                                    <h3  class="s-title-one">How To Select station</h3>
                                                </div>
                                                
                                                <div class="d-icon-box-content">
                                                    <p>After receiving, press the +/- key to select a station</p>
                                                </div>                                        
                                            </div>
                                        </div> 
                                    </div>  
                                    ...
                                    <div class="how-it-drone2-border">
                                        <!-- <div class="how-it-drone2"> -->
                                           <!--  <div class="how-it-drone-media2">
                                                <img src="public/assetsj/images/main-slider/vkd.png" alt="" class="wave-effects">
                                       ...
                                       <div class="slideshow-container" style="margin-top:20px;">
                                            ...
                                            <div class="mySlides fade">
                                                ...
                                                <img src="public/images/musicplayer/product1.jpg" style="width:100%;">

                                            </div>

                                            <div class="mySlides fade">
                                                <div class="numbertext"></div>
                                                <img src="public/images/musicplayer/product3.jpg" style="width:100%;">
 
                                                </div>

                                            <div class="mySlides fade">
                                                <div class="numbertext"></div>
                                                <img src="public/images/musicplayer/product6.jpg" style="width:100%;">

                                                </div> 
                                                <div class="mySlides fade">
                                                <div class="numbertext"></div>
                                                <img src="public/images/musicplayer/product5.jpg" style="width:100%;">
                                ...
                                <div class="col-lg-4 col-md-12 m-b30 how-it-drone3-right">
                                    ...
                                    <div class="wt-box d-icon-box-two m-b40">
                                        <div class="wt-icon-box-wraper left">
                                            ...
                                            <div class="icon-content" style="line-height: 2;">
                                                <div class="d-icon-box-title title-style-2 site-text-secondry">
                                                    <h3  class="s-title-one">How To Connect FM</h3>
                                                </div>                                          
                                                <div class="d-icon-box-content">
                                                    <p>Press the FM mode button.The first available FM channel will automatically start playing.To switch to another FM channel, turn the station selector left/right</p>
                                                </div>  
                                    ...
                                    <div class="wt-box d-icon-box-two m-b40">
                                        <div class="wt-icon-box-wraper left">
                                            ...
                                            <div class="icon-content" style="line-height: 2;">
                                                <div class="d-icon-box-title title-style-2 site-text-secondry">
                                                    <h3  class="s-title-one">How To Play Audio</h3>
                                                </div>
                                                
                                                <div class="d-icon-box-content">
                                                    <p>Click the "play" button twice continuously to enter the automaticreception mode and the automaticreception will end after about 2 minutes</p>
                                                </div>                                        
                                            </div>
                                        </div> 
                                    </div> 
    ...
    <footer class="footer__section footer__bg" style="background-color:#403938">
        <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="footer__widget">
                            ...
                            <div class="footer__widget--inner">
                                <a class="footer__logo" href="home"><img class="footer__logo--img display-block" src="public/assetsj/images/client-logo/logo.jpg" alt="footer-logo"></a>
                                <p class="footer__widget--desc">As the world moves on at a fast pace, the need to keep one's mind calm and immersed in a spiritual plane while living in the present becomes very important</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer__widget">
                            ...
                            <ul class="footer__widget--menu footer__widget--inner">
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="home#about">About Us</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="#">Wishlist</a></li>
                                <li class="footer__widget--menu__list"><a class="footer__widget--menu__text" href="contactus">Contact Us</a></li>
                        ...
                        <div class="quickview__gallery">
                            <div class="product__media--right__horizontal ">
                                <div class="product__media--preview__horizontal  swiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="public/images/banner.jpg"><img class="product__media--preview__items--img" src="public/images/banner.jpg" alt="product-media-img"></a>
                                                <div class="product__badge">
                                                    <span class="product__badge--items sale">New</span>
                                                </div>
                                                <div class="product__media--view__icon">
                                                    <a class="product__media--view__icon--link glightbox" href="public/images/banner.jpg" data-gallery="product-media-preview">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                            <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                        </svg>                                                              
                                                        <span class="visually-hidden">Media Gallery</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="public/images/musicplayer/product2.jpg"><img class="product__media--preview__items--img" src="public/images/musicplayer/product2.jpg" alt="product-media-img"></a>
                                                <div class="product__badge">
                                                    <span class="product__badge--items sale">New</span>
                                                </div>
                                                <div class="product__media--view__icon">
                                                    <a class="product__media--view__icon--link glightbox" href="public/images/musicplayer/product2.jpg" data-gallery="product-media-preview">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                            <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                        </svg>                                                              
                                                        <span class="visually-hidden">Media Gallery</span>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product__media--preview__items">
                                                <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="public/images/musicplayer/product4.jpg"><img class="product__media--preview__items--img" src="public/images/musicplayer/product4.jpg" alt="product-media-img"></a>
                                                <div class="product__badge">
                                                    <span class="product__badge--items sale">New</span>
                                                </div>
                                                <div class="product__media--view__icon">
                                                    <a class="product__media--view__icon--link glightbox" href="public/images/musicplayer/product4.jpg" data-gallery="product-media-preview">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="18" height="18" viewBox="0 0 18 18">
                                                            <image  width="18" height="18" xlink:href="data:image/png;base64,"/>
                                                        </svg>                                                              
                                                        <span class="visually-hidden">Media Gallery</span>
                            ...
                            <div class="product__media--nav__horizontal swiper">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="public/images/musicplayer/product2.jpg" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="public/images/musicplayer/product3.jpg" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="public/images/musicplayer/product4.jpg" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="public/images/musicplayer/product5.jpg" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="public/images/musicplayer/product6.jpg" alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper__nav--btn swiper-button-next"></div>
                                        ...
                                        <fieldset class="variant__input--fieldset">
                                            ...
                                            <div class="variant__color d-flex">
                                                <div class="variant__color--list">
                                                    ...
                                                    <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="assets/img/product/small-product1.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red6" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="assets/img/product/small-product2.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red7" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="assets/img/product/small-product3.webp" alt="variant-color-img"></label>
                                                </div>
                                                <div class="variant__color--list">
                                                    <input id="color-red8" name="color" type="radio">
                                                    <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="assets/img/product/small-product4.webp" alt="variant-color-img"></label>
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
        ...
        <div  class="newsletter__popup--inner">
            ...
            <div class="box newsletter__popup--box d-flex align-items-center">
                <div class="newsletter__popup--thumbnail">
                    <img class="newsletter__popup--thumbnail__img display-block" src="public/images/banner.jpg" alt="newsletter-popup-thumb">
                </div>
