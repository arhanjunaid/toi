  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js"></script>
	...
	<body id="body" class="one-page alternative-font-5" data-plugin-scroll-spy data-plugin-options="{'target': '#header'}">
		...
		<div class="body">
			...
			@include('newheaderLayouts.headernew1')
...
<br/><br/>
			...
			<h4>{{$LoggedUserInfo['firstName']}}<span>{{$LoggedUserInfo['lastName']}}</span> <a href="{{ route('customer.logout') }}" style="margin-left: 20px">logout</a></h4>
							<h4><input type="text" name="id" id="id" value="{{$LoggedUserInfo['id']}}" style="visibility: hidden;"></h4> 
			</div>
			</div>	
					...
					<div class="container py-2">
						...
						<div class="row">
							<div class="col text-center py-4">
								<p class="mb-0">©2022. Vijay Karnataka. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
