...
<meta name="description" content="BV_Ecommerce &#189; Product planner &amp; celebration html Template" />
...
<!-- Latest compiled and minified CSS -->
        ...
        <!-- Skin CSS -->
        <link id="skinCSS" rel="stylesheet" href="public/css/skins/default.css">
                                        ...
                                        <div class="header-nav-main header-nav-main-font-lg header-nav-main-font-lg-upper-2 header-nav-main-mobile-dark header-nav-main-square header-nav-main-dropdown-no-borders header-nav-main-effect-2 header-nav-main-sub-effect-1">
                                            <nav class="collapse">
                                                <ul class="nav nav-pills" id="mainNav">
                                                    <li class="dropdown">
                                                        <a data-hash class="nav-link active" href="home" style="font-size:14px">
                                                            Home
                                                        </a>
                                                        <ul class="dropdown-menu">
                                                            <li><a class="nav-link" href="home#gallery" style="font-size:14px">Image Gallery</a></li>
                                                            <li><a class="nav-link" href="home#videos" style="font-size:14px">Videos</a></li>
                                                        </ul>
                                                    </li>
                                                    <li>
                                                        <a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="home#services" style="font-size:14px">About us</a>
                                                    </li>
                                                    <li>
                                                        <a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="videos" style="font-size:14px">Videos</a>
                                                    </li>
                                                    <li>
                                                        <a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="home#specifications" style="font-size:14px">Specifications</a>
                                                    </li>
                                                    
                                                    <li>
                                                        <a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="contactus" style="font-size:14px">Contact Us</a>
                                                    </li>
                                                    <li>
                                                        <a class="nav-link" data-hash data-hash-offset="0" data-hash-offset-lg="68" href="feedback" style="font-size:14px">Feedback</a>
                                                    </li>
...
<section class="container">
                                    ...
                                    @csrf
                                        ...
                                        <div class="row">
                                            <div class="form-group col-xl-4">
                                                <input type="text" value=""  class="form-control"  placeholder="Name" name="name" id="name" required>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col">
                                                <input type="submit" value="SUBMIT" id="contactdata" class="btn btn-primary btn-rounded font-weight-semibold px-5 btn-py-2 text-2" data-loading-text="Loading...">
                                            </div>
                                        </div>
                                    </form>
        <div class="col-md-2"></div>
    ...
    <footer id="footer" class="bg-transparent border-0 mt-0">
        ...
        <div class="footer-copyright bg-transparent">
             @include('layouts.contactus_footer')
