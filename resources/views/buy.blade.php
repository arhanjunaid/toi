  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js"></script>
	...
	<body id="body" class="one-page alternative-font-5" data-plugin-scroll-spy data-plugin-options="{'target': '#header'}">
		...
		<div class="body">
          ...
          <form enctype="multipart/form-data" method="post"  action="{{ route('final.payment') }}">
           	
          	@csrf
    
						<p>{{$LoggedUserInfo['firstName']}}<span>{{$LoggedUserInfo['lastName']}}</span> <a href="{{ route('customer.logout') }}" style="margin-left: 20px">logout</a></p>
							<p><input type="text" name="id" id="id" value="{{$LoggedUserInfo['id']}}" style="visibility: hidden;"></p> 
          ...
          <!-- <form enctype="multipart/form-data" method="post"  action="finalpayment">
          	@csrf -->
					...
					<div class="container shop pb-4" style="margin-top: -45px;">
						...
						<div class="row">
							<div class="col-lg-5 mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" style="background-color:#F67280">

								<div class="thumb-gallery-wrapper">
									<div class="thumb-gallery-detail owl-carousel owl-theme manual nav-inside nav-style-1 nav-dark nav-arrows-thin mb-3">
										<div>
											<img alt="" class="img-fluid" src="public/productimages/{{$d->image}}" data-zoom-image="public/images/product/product-2.jpeg">
										</div>
										<div>
											<img alt="" class="img-fluid" src="public/images/product/player-1.jpeg" data-zoom-image="public/images/product/player-1.jpeg">
										</div>
										<div>
											<img alt="" class="img-fluid" src="public/images/product/product-6.png" data-zoom-image="public/images/product/product-6.png">
										</div>
										<div>
											<img alt="" class="img-fluid" src="public/images/product/product_bluetooth.jpeg" data-zoom-image="public/images/product/product_bluetooth.jpeg">
										</div>
									</div>
									<div class="thumb-gallery-thumbs owl-carousel owl-theme manual thumb-gallery-thumbs mb-0">
										<div class="cur-pointer">
											<img alt="" class="img-fluid" src="public/images/product/product-2.jpeg">
										</div>
										<div class="cur-pointer">
											<img alt="" class="img-fluid" src="public/images/product/player-1.jpeg">
										</div>
										<div class="cur-pointer">
											<img alt="" class="img-fluid" src="public/images/product/product-6.png">
										</div>
										<div class="cur-pointer">
											<img alt="" class="img-fluid" src="public/images/product/product_bluetooth.jpeg">
										</div>
									</div>
								</div>
...
<br/>
								...
								<!-- 		<table class="table table-borderless" style="max-width: 300px;">
										...
										<!-- 	<div class="quantity quantity-lg float-none me-3 mb-0">
											...
											<!-- <button type="button" class="btn btn-primary btn-rounded font-weight-bold text-3-5 btn-px-5 btn-py-2">Add To Cart</button> --><br><br>
											<button type="submit" class="btn btn-info btn-rounded font-weight-bold text-3-5 btn-px-5 btn-py-2" id="savedata">Place Order</button>
										</div>
									</form>
					...
					<div class="container py-2">
						...
						<div class="row">
							<div class="col text-center py-4">
								<p class="mb-0">Ecommerce © Copyright 2021. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
