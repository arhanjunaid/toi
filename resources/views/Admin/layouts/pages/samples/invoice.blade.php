         ...
         <!--  <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="e-commerce">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.orders') }}"> Invoice </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.pricing_table') }}"> Pricing Table </a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('admin.Dashboard') }}"> Orders </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
                      ...
                      <div class="card-body">
                          ...
                          <div class="container-fluid d-flex justify-content-between">
                            <div class="col-lg-3 pl-0">
                              <p class="mt-5 mb-2"><b>Admin Dashboard</b></p>
                              <p>doorno,<br>street name,<br>state, country pincode.</p>
                            </div>
                            <div class="col-lg-3 pr-0">
                              <p class="mt-5 mb-2 text-right"><b>Invoice to</b></p>
                              <p class="text-right">Client name,<br> C-201, Beykoz-34800,<br> Canada, K1A 0G9.</p>
                            </div>
                          </div>
                          <div class="container-fluid d-flex justify-content-between">
                            <div class="col-lg-3 pl-0">
                          ...
                          <div class="container-fluid mt-5 w-100">
                            <p class="text-right mb-2">Sub - Total amount: RS.12,348</p>
                            <p class="text-right">vat (10%) : RS.138</p>
                            <h4 class="text-right mb-5">Total : RS.13,986</h4>
                            <hr>
                          </div>
