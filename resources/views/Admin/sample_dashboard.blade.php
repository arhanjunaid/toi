  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row default-layout-navbar">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="adminDashboard"><img src="public/admin_assets/images/faces/logo.jpeg" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="adminDashboard"><img src="public/admin_assets/images/faces/logo1.png" alt="logo"/></a>
      </div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="page-layouts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item d-none d-lg-block"> <a class="nav-link" href="catalog">Catalog</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="e-commerce">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="pricing_table"> Pricing Table </a></li>
                <li class="nav-item"> <a class="nav-link" href="orders"> Orders </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="public/admin_assets/pages/documentation.html">
                    ...
                    <table class="table">
                      <tbody>
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="public/admin_assets/images/faces/face13.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="public/admin_assets/images/faces/face2.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Mae Saunders
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="py-1">
                            <img src="public/admin_assets/images/faces/face11.html" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td class="font-weight-bold">
                            Marguerite Phillips
                          </td>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="public/admin_assets/images/faces/face1.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            South Shyanne
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="public/admin_assets/images/faces/face3.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            East Helga
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="public/admin_assets/images/faces/face4.jpg" alt="profile" class="img-sm rounded-circle"/>
                          </td>
                          <td>
                            Omerbury
                          </td>
