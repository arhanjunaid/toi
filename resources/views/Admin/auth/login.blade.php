                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content">
                            <h1 class="breadcrumb__content--title mb-10">Login</h1>
                            <ul class="breadcrumb__content--menu d-flex">
                                <li class="breadcrumb__content--menu__items"><a href="home">Home</a></li>
                                <li class="breadcrumb__content--menu__items"><span class="text__secondary">Login</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
					...
					<div class="row">
						...
						<div class="col-md-8 ">
							<div class="card border-width-3 border-radius-0 border-color-hover-dark">
								<div class="card-body">
								<h2 style="text-align:center;color:white;background-color:#006666;padding:10px;border-radius:10px">Login</h2>
									<br/>
									...
									@csrf
										<div class="row">
											<div class="form-group col">
												...
												<input type="text" value="" name="email" name="phone_number" class="form-control form-control-lg text-4" value="{{ old('email') }}"required>
